...
public class BankAccount {
    ...
    private boolean isLoggedIn; // Indicates whether the user is logged in
    private double balance; // Stores the balance of the user
    ...
    // Public method to request a password reset. Includes a verification step.
    public void requestPasswordReset(String currentPassword, String newPassword) {
        if (isLoggedIn && this.password.equals(currentPassword)) {
            resetPassword(newPassword);
        } else {
            System.out.println("Password reset failed. Incorrect current password or user not logged in.");
        }
    }

    // Private method that actually resets the password.
